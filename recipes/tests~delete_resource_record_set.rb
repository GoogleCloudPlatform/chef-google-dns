...
#       "recipe[gdns::tests~delete_resource_record_set]"
#
...
gdns_resource_record_set 'chef-e2e-www.testzone-4.com.' do
  action :delete
  managed_zone 'chef-e2e-testzone-4-com'
  type 'A'
  project 'google.com:graphite-playground'
  credential 'mycred'
end

gdns_resource_record_set 'chef-e2e-sites.testzone-4.com.' do
  action :delete
  managed_zone 'chef-e2e-testzone-4-com'
  type 'CNAME'
  project 'google.com:graphite-playground'
...
gdns_managed_zone 'chef-e2e-testzone-4-com' do
  action :delete
  project 'google.com:graphite-playground'
  credential 'mycred'
end
