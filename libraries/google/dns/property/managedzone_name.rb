...
module Google
  module Dns
    module Data
      ...
      class ManagedZoneNameRefCatalog < ManagedZoneNameRef
        ...
        def resource
          ...
          raise ArgumentError, "gdns_managed_zone[#{@title}] required"
        end
      end
    ...
    module Property
      ...
      class ManagedZoneNameRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Dns::Property::ManagedZoneNameRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::ManagedZoneNameRef
          Data::ManagedZoneNameRefCatalog.new(value, parent_resource)
        end
