...
context 'gdns_managed_zone' do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  gdns_managed_zone 'title0' do
                    action :create
                    description 'test description#0 data'
                    dns_name 'test dns_name#0 data'
                    name_server_set ['uu', 'vv']
                    project 'test project#0 data'
                    credential 'mycred'
                  end

                  gdns_managed_zone 'title1' do
                    action :create
                    description 'test description#1 data'
                    dns_name 'test dns_name#1 data'
                    name_server_set ['rr', 'ss', 'tt']
                    project 'test project#1 data'
                    credential 'mycred'
                  end

                  gdns_managed_zone 'title2' do
                    action :create
                    description 'test description#2 data'
                    dns_name 'test dns_name#2 data'
                    name_server_set ['oo', 'pp', 'qq', 'rr']
            ...
            context 'gdns_managed_zone[title0]' do
              subject do
            ...
            context 'gdns_managed_zone[title1]' do
              subject do
          ...
          before do
            ...
            expect_network_create \
              1,
              {
                ...
                'description' => 'test description#0 data',
                'dnsName' => 'test dns_name#0 data',
                'name' => 'title0',
                'nameServerSet' => %w[uu vv]
              },
              name: 'title0'
          end
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gdns_managed_zone,
                                       'title0')
          end
        end
  ...
  def expect_network_create(id, expected_body, data = {})
    ...
    body = { kind: 'dns#managedZone' }.to_json
  ...
  def expect_network_delete(id, name = nil, data = {})
    ...
    expect(Google::Dns::Network::Delete).to receive(:new)
