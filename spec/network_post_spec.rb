...
describe Google::Dns::Network::Post do
  let(:credential) { TestCred.new }
  let(:uri_in) { Google::Dns::NetworkBlocker::ALLOWED_TEST_URI }
  ...
  context 'successful request' do
    before(:each) do
      Google::Dns::NetworkBlocker.instance.allow_post(
  ...
  context 'failed request' do
    before(:each) { Google::Dns::NetworkBlocker.instance.deny(uri_in) }
